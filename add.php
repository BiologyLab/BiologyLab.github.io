...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO holdingcage (`cage id`, `pi name`, `strain`, `IACUC`, `user`, `qty`, `DOB`, `sex`, `parentcage`, `mouse id`, `genotype`)
                VALUES ('$cageID', '$piName', '$strain', '$iacuc', '$user', '$qty', '$dob', '$sex', '$parentCage', '$mouseIDs', '$genotypes')";
